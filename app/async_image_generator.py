    ...
    async def _process_and_store_image(
        ...
        try:
            ...
            if stamp_image:
                ...
                logger.info(f"[Async] Stamped image uploaded to Imgur. URL: {stamped_imgur_url}")
            ...
            raise ImageGenerationError(f"[Async] Failed to process or store image: {str(e)}") from e 
...
class K8sJobManager:
    ...
    def create_commission_job(self, donation: Donation, task_data: Dict[str, Any]) -> Optional[str]:
        """
        ...
        try:
            job_name = f"commission-{donation.id}-{datetime.now().strftime('%Y%m%d-%H%M%S')}"
    ...
    def _create_job_manifest(self, job_name: str, donation_id: int, task_data: Dict[str, Any]) -> Dict[str, Any]:
        """

...
def setup_logging(
    log_level: str = "INFO", log_file: str = None, console_output: bool = True
) -> None:
    """
...
def log_operation(
    ...
    if error:
        log_data["error"] = {"type": error.__class__.__name__, "message": str(error)}
    ...
    def decorator(func: Callable):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                log_operation(
                    logger, operation, "success", {"duration_seconds": duration}
                )
                return result

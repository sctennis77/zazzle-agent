...
class OpenAIUsageTracker:
    ...
    def get_session_summary(self) -> Dict[str, Any]:
        ...
        avg_response_time = sum(u.response_time_ms for u in self.usage_history) / total_calls if total_calls > 0 else 0
        ...
        for usage in self.usage_history:
            ...
            if usage.success:
                ...
                if usage.error_message:
                    ...
                    error_type = "unknown"
                    if "429" in usage.error_message or "rate limit" in usage.error_message.lower():
                        error_type = "rate_limit"
                    elif "quota" in usage.error_message.lower() or "insufficient_quota" in usage.error_message.lower():
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if "429" in error_message or "rate limit" in error_message.lower():
                    ...
                    logger.error(f"❌ API call failed for {model} - {operation}: {error_message}")

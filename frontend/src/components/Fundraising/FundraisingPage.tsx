...
const FundraisingPage: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      console.warn('Using mock data for testing:', err);
      // Fallback to mock data for testing
      const mockData: FundraisingData = {
        "golf": {
          commission: {
            reddit_username: "golfFan123",
            tier_name: "gold",
            tier_min_amount: 10.0,
            donation_amount: 15.0,
            is_anonymous: false,
            created_at: "2025-01-15T10:30:00Z",
            donation_id: 1,
            commission_message: "Make it golf-themed!",
            commission_type: "specific_post"
          },
          support: [
            {
              reddit_username: "golfSupporter1",
              tier_name: "bronze",
              tier_min_amount: 1.0,
              donation_amount: 2.0,
              is_anonymous: false,
              message: "Love the golf designs!",
              created_at: "2025-01-14T15:20:00Z",
              donation_id: 2
            },
            {
              reddit_username: "golfSupporter2",
              tier_name: "silver",
              tier_min_amount: 5.0,
              donation_amount: 7.0,
              is_anonymous: true,
        ...
        "biology": {
          ...
          support: [
            {
              reddit_username: "bioStudent",
              tier_name: "emerald",
              tier_min_amount: 25.0,
              donation_amount: 30.0,
              is_anonymous: false,
              message: "Amazing biology illustrations!",
        ...
        "meditation": {
          commission: {
            reddit_username: "zenMaster",
            tier_name: "platinum",
            tier_min_amount: 50.0,
            donation_amount: 75.0,
            is_anonymous: false,
            created_at: "2025-01-10T14:20:00Z",
            donation_id: 6,
            commission_message: "Create something peaceful",
            commission_type: "random_subreddit"
          },
          support: [
            {
              reddit_username: "peacefulOne",
              tier_name: "ruby",
              tier_min_amount: 100.0,
              donation_amount: 125.0,
              is_anonymous: false,
              message: "Your art brings peace to my day",

...
QR_URL = "https://clouvel.ai"  # Change as needed
QR_SIZE = 512  # px
...
logo_bg = (
    Image.open(LOGO_BG_PATH).convert("RGBA").resize((QR_SIZE, QR_SIZE), Image.LANCZOS)
)
...
print(
    f"Features: Prepped logo background, QR modules with dark blue gradient and partial transparency, high error correction"
)

    ...
    def generate_product(self, prompt: str) -> Dict:
        ...
        try:
            ...
            try:
                ...
                logger.info(f"Successfully generated design: {design_data['imgur_url']}")
            ...
            if not all([cap_url, zazzle_email, zazzle_password]):
                logger.error("Missing required environment variables for publishing. Please set ZAZZLE_EMAIL and ZAZZLE_PASSWORD.")
            else:
        ...
        try:
            ...
            for prompt in prompts:
                try:
                    ...
                    logger.error(f"Failed to generate product for prompt '{prompt}': {str(e)}")
                    continue

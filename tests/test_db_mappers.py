...
from app.db.mappers import (
    product_idea_to_db, db_to_product_idea,
    reddit_context_to_db, db_to_reddit_context
)
...
def test_product_idea_to_db_and_back():
    ...
    idea = ProductIdea(
        ...
        design_instructions={'image': 'https://imgur.com/test.png', 'template_id': 'tmpl123', 'product_type': 'sticker'},
        reddit_context=ctx,
        model='dall-e-3',
    ...
    assert idea2.design_instructions['template_id'] == idea.design_instructions['template_id']
    assert idea2.design_instructions['product_type'] == idea.design_instructions['product_type']

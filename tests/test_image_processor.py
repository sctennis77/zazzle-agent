...
from app.services.image_processor import ImageProcessingError, ImageProcessor
...
class TestImageProcessor:
    ...
    def test_init_with_defaults(self):
        ...
        assert (
            processor.signature_font_size == ImageProcessor.DEFAULT_SIGNATURE_FONT_SIZE
        )
    ...
    def test_process_image_logo_only(self):
        ...
        result = processor.process_image(
            self.test_image, add_logo=True, add_signature=False
        )
    ...
    def test_process_image_signature_only(self):
        ...
        result = processor.process_image(
            self.test_image, add_logo=False, add_signature=True
        )
    ...
    def test_process_image_both_logo_and_signature(self):
        ...
        result = processor.process_image(
            self.test_image, add_logo=True, add_signature=True
        )
    ...
    def test_process_image_neither_logo_nor_signature(self):
        ...
        result = processor.process_image(
            self.test_image, add_logo=False, add_signature=False
        )
    ...
    def test_stamp_image_with_logo_custom_stamp_size(self):
        ...
        processor = ImageProcessor(
            logo_path=self.temp_logo.name, stamp_size=custom_stamp_size
        )
    ...
    def test_stamp_image_with_logo_custom_opacity(self):
        ...
        custom_opacity = 0.7
        processor = ImageProcessor(
            logo_path=self.temp_logo.name, watermark_opacity=custom_opacity
        )

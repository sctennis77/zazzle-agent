...
def test_optimized_logic():
    ...
    mock_imgur_client.upload_image.return_value = (
        "https://i.imgur.com/test123.jpeg",
        "test123.jpeg",
    )

    # Mock the image processor
    mock_image_processor = Mock()
    mock_image_processor.stamp_image_with_logo.return_value = Image.new(
        "RGB", (1024, 1024), color="red"
    )

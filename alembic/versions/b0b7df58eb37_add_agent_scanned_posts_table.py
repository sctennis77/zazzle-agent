...
def upgrade() -> None:
    ...
    op.create_index('ix_agent_scanned_posts_promoted_scanned_at', 'agent_scanned_posts', ['promoted', 'scanned_at'], unique=False)


def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index('ix_agent_scanned_posts_promoted_scanned_at', table_name='agent_scanned_posts')

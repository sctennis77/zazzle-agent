...
def upgrade() -> None:
    ...
    if 'image_quality' not in columns:
        ...
        op.add_column('product_infos', sa.Column('image_quality', sa.String(16), nullable=False, server_default='standard'))
        # Create index on image_quality column
        op.create_index('ix_product_infos_image_quality', 'product_infos', ['image_quality'])
